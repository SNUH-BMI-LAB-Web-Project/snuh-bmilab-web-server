...
public record CreatePatentRequest(
        @Schema(description = "출원일자", example = "2025-05-10")
        LocalDate applicationDate,
        @Schema(description = "출원번호", example = "10-2023-0058211")
        String applicationNumber,
        @Schema(description = "출원명", example = "인공지능 기반 의료 데이터 분석 장치")
        String patentName,
        @Schema(description = "출원인(전체)", example = "서울대학교병원, 김연구")
