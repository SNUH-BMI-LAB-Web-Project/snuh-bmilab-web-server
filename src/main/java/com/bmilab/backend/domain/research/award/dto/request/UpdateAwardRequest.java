...
public record UpdateAwardRequest(
        @Schema(description = "수상자 목록 (텍스트)", example = "김연구, 박개발")
        String recipients,
        @Schema(description = "연구실 내 수상자 (구성원 연동)")
        List<AwardRecipientRequest> awardRecipients,
        @Schema(description = "수상 날짜", example = "2025-11-16")
        LocalDate awardDate,
        @Schema(description = "주최 기관", example = "대한의료인공지능학회")
        String hostInstitution,
        @Schema(description = "대회명", example = "2023년 대한의료인공지능학회 춘계학술대회")
        String competitionName,
        @Schema(description = "수상명", example = "최우수 포스터상")
        String awardName,
