...
public record UpdateAcademicPresentationRequest(
        @Schema(description = "발표자 목록 (텍스트)", example = "김연구, 박개발")
        String authors,
        @Schema(description = "연구실 내 발표자 (구성원 연동)")
        List<AcademicPresentationAuthorRequest> academicPresentationAuthors,
        @Schema(description = "학회 시작일", example = "2025-11-11")
        LocalDate academicPresentationStartDate,
        @Schema(description = "학회 종료일", example = "2025-11-13")
        LocalDate academicPresentationEndDate,
        @Schema(description = "학회 장소", example = "벡스코")
        String academicPresentationLocation,
        @Schema(description = "학회 주최", example = "대한의료정보학회")
        String academicPresentationHost,
        @Schema(description = "학회명", example = "2025년 대한의료정보학회 동계학술대회")
        String academicPresentationName,
        @Schema(description = "발표 타입", example = "ORAL")
        AcademicPresentationType presentationType,
        @Schema(description = "발표 제목", example = "차세대 인공지능 기반 의료영상 분석 시스템")
